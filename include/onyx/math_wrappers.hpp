...
namespace onyx
{
	...
	namespace math
	{
		...
		public:
			...
			static Vec3 yellow();
			static Vec3 green();
			static Vec3 dark_green();
			static Vec3 cyan();
			static Vec3 light_blue();
			static Vec3 blue();
			static Vec3 navy_blue();
			static Vec3 purple();
			static Vec3 pink();
			static Vec3 magenta();
			static Vec3 white();
			static Vec3 light_gray();
			static Vec3 dark_gray();
			static Vec3 black();
			static Vec3 brown();
		...
		public:
			...
			static Vec4 dark_green(float alpha = 1.0f);
			static Vec4 cyan(float alpha = 1.0f);
			static Vec4 light_blue(float alpha = 1.0f);
			static Vec4 blue(float alpha = 1.0f);
			static Vec4 navy_blue(float alpha = 1.0f);
			...
			static Vec4 light_gray(float alpha = 1.0f);
			static Vec4 dark_gray(float alpha = 1.0f);
		...
		public:
			...
			int get_x() const;
			int get_y() const;
			const glm::ivec2& get_mvec() const;
		...
		public:
			...
			int get_y() const;
			int get_z() const;
			const glm::ivec3& get_mvec() const;
		...
		public:
			...
			int get_z() const;
			int get_w() const;
			const glm::ivec4& get_mvec() const;
		...
		public:
			...
			u32 get_x() const;
			u32 get_y() const;
			const glm::uvec2& get_mvec() const;
		...
		public:
			...
			UVec3(const UVec2& vec, u32 z);
			UVec3(u32 x, const UVec2& vec);
			...
			u32 get_y() const;
			u32 get_z() const;
			const glm::uvec3& get_mvec() const;

			void set_x(u32 x);
			void set_y(u32 y);
			void set_z(u32 z);
			void set(u32 x, u32 y, u32 z);
		...
		public:
			UVec4();
			UVec4(u32 xyzw);
			UVec4(u32 x, u32 y, u32 z, u32 w);
			UVec4(const UVec2& vec, u32 z, u32 w);
			UVec4(u32 x, const UVec2& vec, u32 w);
			UVec4(u32 x, u32 y, const UVec2& vec);
			UVec4(const UVec3& vec, u32 w);
			UVec4(u32 x, const UVec3& vec);
			...
			u32 get_z() const;
			u32 get_w() const;
			const glm::uvec4& get_mvec() const;

			void set_x(u32 x);
			void set_y(u32 y);
			void set_z(u32 z);
			void set_w(u32 w);
			void set(u32 x, u32 y, u32 z, u32 w);
		...
		public:
			...
			void scale(const Vec3& xyz_multiplier);
		...
		Mat4x4 look_at(const Vec3& pos, const Vec3& target, const Vec3& up);

		Mat4x4 orthographic_projection(float left, float right, float top, float bottom);
		Mat4x4 perspective_projection(float fov, float aspect_ratio, float near_plane, float far_plane);
