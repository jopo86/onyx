...
namespace onyx
{
	...
	public:
		...
		/*
			...
			@param model The model to create the ModelRenderable from.
			@param shader_override The shader to use instead of the model's shader.
		 */
		ModelRenderable(Model& model, Shader shader_override);
	...
	private:
		std::map<std::string, Renderable> renderable_map;
