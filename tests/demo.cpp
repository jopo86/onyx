...
void demo::run(bool log_progress)
{
	if (log_progress) std::cout << "\nOnyx v" << onyx::get_version_string() << " demo\n";
	...
	if (implicit_init)
	{
		...
		if (log_progress) std::cout << " -- Onyx initialized\n";
	}
	...
	if (log_progress) std::cout << " -- Window created\n";
	window.init();
	if (log_progress) std::cout << " -- Window initialized\n";
	...
	icon.dispose();
	if (log_progress) std::cout << " -- Window icon loaded & set\n";

	onyx::InputHandler input;
	window.link_input_handler(input);
	if (log_progress) std::cout << " -- Input handler created & linked\n";
	...
	if (log_progress) std::cout << " -- Camera created & linked\n";
	...
	if (log_progress) std::cout << " -- Renderer created & linked\n";
	...
	if (log_progress) std::cout << " -- Fonts loaded (" << duration << "ms)\n";
	...
	if (log_progress) std::cout << " -- " << CUBE_COUNT << " cubes created\n";
	...
	if (log_progress) std::cout << " -- Created renderables (" << duration << "ms)\n";
	...
	if (log_progress) std::cout << " -- Starting mainloop\n";
	...
	if (log_progress) std::cout << " -- Mainloop ended\n";
