...
namespace onyx
{
	...
	public:
		...
		/*
			...
			@param type The type of standard cursor to create. Must not be CursorType::Null or CursorType::Custom.
			@param result A pointer to a boolean that will be set to true if the cursor was created successfully, false otherwise.
			@return The created cursor.
		 */
		static Cursor standard(CursorType type, bool* result = nullptr);
